...
var AppView = require('panda-modules/bg-videos/views/app');
...
},{"panda-modules/bg-videos/views/app":9,"panda/services/launch-config":5}],8:[function(require,module,exports){
var templates = null;
module.exports = {};

templates = null;
module.exports["bg-videos/templates/app"] = "<div class=\"pnd-bg-video-wrapper\">\n" +
...
var templates = require('panda-modules/bg-videos/templates');

var ls = window.localStorage;

module.exports = Backbone.View.extend({
    el: '.js-launcher-view-container',
    template: templates['bg-videos/templates/app'],
    events: {
    ...
    render: function () {
        ...
        self.$el.addClass(self.mode)
            .addClass('pnd-launcher-mode pnd-app-bg-video');

        self.$video = this.$el.find('#bg-video');
        self.$video.attr('src', self.videoUrl);

        return self;
    },
    getVideoUrl: function () {
        var videos= [
            'https://scontent-amt2-1.cdninstagram.com/t50.2886-16/13484615_1206717736014847_717595630_n.mp4',
            'https://scontent-amt2-1.cdninstagram.com/t50.2886-16/13592993_615278218649564_1857269597_n.mp4',
            'https://scontent-amt2-1.cdninstagram.com/t50.2886-16/14230257_888744054590115_1413079135_n.mp4'
        ];

        var nextIndex = parseInt(ls.getItem('bgvideo.launcher.index')) + 1 || 0;

        if (nextIndex >= videos.length)
            nextIndex = 0;

        ls.setItem('bgvideo.launcher.index', nextIndex);
...
},{"backbone":1,"panda-modules/bg-videos/templates":8,"panda/data/launcher/types":4}]},{},[6]);
