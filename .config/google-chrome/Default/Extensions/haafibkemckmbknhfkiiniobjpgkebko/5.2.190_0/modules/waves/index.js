...
module.exports = function (canvas) {
    ...
    canvas.ontouchstart = color;
    canvas.onmousedown = color;
...
var AppView = require('panda-modules/waves/views/app');
...
},{"panda-modules/waves/views/app":10,"panda/services/launch-config":5}],9:[function(require,module,exports){
var templates = null;
module.exports = {};

templates = null;
module.exports["waves/templates/app"] = "<div class=\"pnd-waves\">\n" +
...
var templates = require('panda-modules/waves/templates');

var initWaves = require('panda-modules/waves/lib/waves');

module.exports = Backbone.View.extend({
    el: '.js-launcher-view-container',
    template: templates['waves/templates/app'],
    events: {
    ...
    render: function () {
        ...
        self.$el.addClass(self.mode)
            .addClass('pnd-launcher-mode pnd-app-waves');

        initWaves(document.getElementById('waves-canvas'));
...
},{"backbone":1,"panda-modules/waves/lib/waves":7,"panda-modules/waves/templates":9,"panda/data/launcher/types":4}]},{},[6]);
