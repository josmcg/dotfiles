...
var AppView = require('panda-modules/dashboard/views/app');
...
},{"panda-modules/dashboard/views/app":9,"panda/services/launch-config":5}],8:[function(require,module,exports){
var templates = null;
module.exports = {};

templates = null;
module.exports["dashboard/templates/app"] = "<div class=\"pnd-launcher-widget pnd-widget-left-top\"></div>\n" +
   "";

},{}],9:[function(require,module,exports){
var Backbone = require('backbone');

var templates = require('panda-modules/dashboard/templates');

var TodoWidget = require('panda-modules/widgets/todo');

module.exports = Backbone.View.extend({
    el: '.js-launcher-view-container',
    template: templates['dashboard/templates/app'],
    ...
    render: function () {
        ...
        self.$el.addClass(self.mode)
            .addClass('pnd-launcher-mode pnd-app-dashboard');

        TodoWidget.apply({
            el: '.pnd-widget-left-top',
            mode: self.mode,
...
},{"backbone":1,"panda-modules/dashboard/templates":8,"panda-modules/widgets/todo":12,"panda/data/launcher/types":4}],10:[function(require,module,exports){
var templates = null;
module.exports = {};

templates = null;
module.exports["widgets/hello/templates/app"] = "<h1>Hello widget!</h1>\n" +
   "";

templates = null;
module.exports["widgets/todo/templates/app"] = "<div class=\"new-todo\">\n" +
   "    <input type=\"text\" class=\"new-todo-input\">\n" +
   "    <button type=\"button\" class=\"new-todo-add\">Add</button>\n" +
   "</div>\n" +
   "<ul class=\"todo-list\"></ul>\n" +
   "";

templates = null;
module.exports["widgets/todo/templates/todo"] = "<div class=\"task-wrapper\">\n" +
   "    <div> <%= completed %> </div>\n" +
...
var TodoModel = require('panda-modules/widgets/todo/models/todo');
...
},{"backbone":1,"panda-modules/widgets/todo/models/todo":13}],12:[function(require,module,exports){
var AppView = require('panda-modules/widgets/todo/views/app');
var app;
...
},{"panda-modules/widgets/todo/views/app":14}],13:[function(require,module,exports){
var Backbone = require('backbone');
...
var templates = require('panda-modules/widgets/templates');

var Todos = require('panda-modules/widgets/todo/collections/todos');
var TodoView = require('panda-modules/widgets/todo/views/todo');

module.exports = Backbone.View.extend({
    name: 'pnd-widget-todo',
    template: templates['widgets/todo/templates/app'],
    events: {
        'click .new-todo-add': 'create'
    },
    initialize: function (options) {
        this.mode = options.mode;
    ...
    render: function () {
        ...
        self.$el.html(self.template);
        this.$input = this.$el.find('.new-todo-input');
...
},{"backbone":1,"panda-modules/widgets/templates":10,"panda-modules/widgets/todo/collections/todos":11,"panda-modules/widgets/todo/views/todo":15}],15:[function(require,module,exports){
var Backbone = require('backbone');
...
module.exports = Backbone.View.extend({
    tagName: 'li',
    template: _.template(templates['widgets/todo/templates/todo']),
    events: {
...
},{"backbone":1,"panda-modules/widgets/templates":10,"underscore":3}]},{},[6]);
