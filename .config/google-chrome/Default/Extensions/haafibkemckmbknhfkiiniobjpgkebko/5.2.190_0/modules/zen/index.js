...
},{"dexie":1}],6:[function(require,module,exports){
...
},{"panda-modules/lib/user":8,"panda-modules/lib/utils":9}],8:[function(require,module,exports){
var ls = window.localStorage;
...
},{"panda-modules/lib/request":6}],9:[function(require,module,exports){
var reEscapeChar = /\\(\\)?/g;
...
var mode = require('./modes')[LaunchConfig.getPreviewLaunchMode() || LaunchConfig.getLaunchMode()];

if (mode) {
    showLauncher();

    if (LaunchConfig.isPreview()) return;

    window.onbeforeunload = clearMouseMove;
...
function showLauncher() {
    mode.component.render();
}

function showApp() {
    window._pnd_loadModule(LauncherTypes.PANDA5, function () {
        mode.component.destroy();
        mode.component = null;
    });
}

},{"./modes":17,"panda/data/launcher/types":3,"panda/services/launch-config":4}],11:[function(require,module,exports){
module.exports = ZenModeComponent;

function ZenModeComponent(options) {
    this.tagName_ = options.tagName || 'div';
    this.className_ = options.className || '';
    this.parentSelector_ = options.parentSelector || 'body';
    this.template_ = options.template || '';

    this.onDestroy_ = options.onDestroy;
    this.onRender_ = options.onRender;

    this.element_ = null;
}

ZenModeComponent.prototype.createDom = function (options) {
    options = options || {};
    var template = this.template_;
    var elm = document.createElement(this.tagName_);

    elm.className = this.className_;

    if (options.noPandaLogo !== false)
        template += '<div class="pnd-launcher-logo"></div>';
...
ZenModeComponent.prototype.getElement = function () {
    return this.element_;
};


ZenModeComponent.prototype.render = function (parent) {
    var parentElm = document.querySelector(parent || this.parentSelector_);

    if (!parentElm) {
        throw new Error('Specified parent element not found.');
    }

    parentElm.appendChild(this.element_ || this.createDom());
    this.onRender_ && this.onRender_.call(this);
};


ZenModeComponent.prototype.destroy = function () {
    var self = this;
    ...
    this.onDestroy_ && this.onDestroy_.call(this);
    setTimeout(function () {
        elm.parentNode.removeChild(elm);
        elm = self.element_ = null;
    }, 1000);
};
...
},{"panda-modules/lib/db":5,"panda-modules/lib/request":6,"panda-modules/lib/settings":7,"panda/services/launch-config":4}],13:[function(require,module,exports){
var ZenModeComponent = require('../lib/mode-component');

var BlankModeComponent = new ZenModeComponent({
    className: 'pnd-launcher-mode pnd-app-blank'
});

exports.component = BlankModeComponent;

},{"../lib/mode-component":11}],14:[function(require,module,exports){
var ZenModeComponent = require('../lib/mode-component');
var Photo = require('../lib/photo');

var ClockModeComponent = new ZenModeComponent({
    className: 'pnd-launcher-mode pnd-app-clock animated fadeIn',
    template: '<span class="clock" id="launcher-clock"></span>',
    onRender: function () {
        ...
        this.inverval_ = setInterval(setClock, 5000);

        setClock();

        function setClock() {
            var now = new Date();
            var hours = twoDigitString(now.getHours());
            var minutes = twoDigitString(now.getMinutes());
            document.getElementById('launcher-clock').innerText = hours + ':' + minutes;
        }
    ...
    onDestroy: function () {
        window.clearInterval(this.inverval_);
    }
});

exports.component = ClockModeComponent;

},{"../lib/mode-component":11,"../lib/photo":12}],15:[function(require,module,exports){
var ZenModeComponent = require('panda-modules/zen/lib/mode-component');
...
var ClockModeComponent = new ZenModeComponent({
    className: 'pnd-launcher-mode pnd-app-flip-clock animated fadeIn',
    template: template(),
    onRender: function () {
        var $element = $(this.getElement());
        ...
        function applySettings(settings) {
            if (!settings || !settings.bg)
                return;

            switch (settings.bg.type) {
                case 'color':
                    $element.css('background', settings.bg.color);
                    break;
                case 'gradient':
                    $element.css('background', utils.gradiateColors(settings.bg.gradient));
                    break;
                case 'photo':
                    Photo.apply({
                        app: 'zen-flip-clock',
        ...
        function setAttributes() {
            ...
            $element.find('.js-clock[data-dur="hh"]').attr('data-cur', hours + 1);
            minutes = timeNow.getMinutes();
            if (minutes < 10) {
                $element.find('.js-clock[data-dur="mm"]').attr('data-cur', 1);
                $element.find('.js-clock[data-dur="m"]').attr('data-cur', minutes + 1);
            } else {
                $element.find('.js-clock[data-dur="mm"]').attr('data-cur', nthDigit(minutes, 0) + 1);
                $element.find('.js-clock[data-dur="m"]').attr('data-cur', nthDigit(minutes, 1) + 1);
            }
            seconds = timeNow.getSeconds();
            minutes = timeNow.getMinutes();
            if (seconds < 10) {
                $element.find('.js-clock[data-dur="ss"]').attr('data-cur', 1.);
                return $element.find('.js-clock[data-dur="s"]').attr('data-cur', seconds + 1);
            } else {
                $element.find('.js-clock[data-dur="ss"]').attr('data-cur', nthDigit(seconds, 0) + 1);
                return $element.find('.js-clock[data-dur="s"]').attr('data-cur', nthDigit(seconds, 1) + 1);
            }
        }

        function startClock() {
            return setInterval(function () {
                return tick($element.find('.js-clock[data-dur="s"]'));
            }, 1000);
        }

        function appendEls() {
            return $element.find('.js-clock').each(function () {
        ...
        function attachEvents() {
            $element.find('.js-clock').on('click', function (e) {
                var $el;
                e.preventDefault();
                $el = $(this);
                return tick($el);
            ...
            $(document).on('10s', function () {
                return tick($element.find('.js-clock[data-dur="ss"]'));
            });
            $(document).on('60s', function () {
                return tick($element.find('.js-clock[data-dur="m"]'));
            });
            return $(document).on('10m', function () {
                tick($element.find('.js-clock[data-dur="mm"]'));
                $(document).on('60m', function () {});
                return tick($element.find('.js-clock[data-dur="hh"]'));
            });
        }
    },
    onDestroy: function () {
...
function getSettings() {
    if (LaunchConfig.isPreview()) {
        return LaunchConfig.getPreviewSettings();
    } else {
        var launcherSettings = Settings.get('launcher') || {};
        var flipClockSettings = (launcherSettings.modes || {})['zen-flip-clock'];

        return flipClockSettings;
    }
}
...
function enableTransitions($el) {
    return $el.removeClass('pnd-app-flip-clock--transitions-off');
}
...
function reset($el) {
    $el.addClass('pnd-app-flip-clock--transitions-off');
...
function nthDigit(int, nth) {
    return parseInt(int.toString().substr(nth, 1));
}

function template() {
    return [
        '<div id="launcher-flip-clock">',
        '<time>',
        '<div class="clock">',
...
},{"jquery":2,"panda-modules/lib/settings":7,"panda-modules/lib/utils":9,"panda-modules/zen/lib/mode-component":11,"panda-modules/zen/lib/photo":12,"panda/services/launch-config":4}],16:[function(require,module,exports){
var ZenModeComponent = require('panda-modules/zen/lib/mode-component');
var Settings = require('panda-modules/lib/settings');
var LaunchConfig = require('panda/services/launch-config');
var $ = require('jquery');

var GradientModeComponent = new ZenModeComponent({
    className: 'pnd-launcher-mode pnd-app-gradient animated fadeIn',
    template: '<div id="zen-gradient-mode></div>"',
    onRender: function () {
        var $element = $(this.getElement());

        var settings = getSettings();

        if (!settings || !settings.bg || !settings.bg.gradient)
            return;

        var colors = settings.bg.gradient;
        var gradient = colors.join(',');

        $element.css('background', colors[0]);
        $element.css('background', '-webkit-linear-gradient(to left, ' + gradient + ')');
        $element.css('background', 'linear-gradient(to left, ' + gradient +')');
    }
});

module.exports.component = GradientModeComponent;
...
function getSettings() {
    if (LaunchConfig.isPreview()) {
        ...
        var launcherSettings = Settings.get('launcher') || {};
        var flipClockSettings = (launcherSettings.modes || {})['zen-gradient'];

        return flipClockSettings;
    }
}

},{"jquery":2,"panda-modules/lib/settings":7,"panda-modules/zen/lib/mode-component":11,"panda/services/launch-config":4}],17:[function(require,module,exports){
exports.blank = require('./blank');
exports.clock = require('./clock');
exports['flip-clock'] = require('./flip-clock');
exports.gradient = require('./gradient');
exports.photo = require('./photo');
exports['swiss-clock'] = require('./swiss-clock');

},{"./blank":13,"./clock":14,"./flip-clock":15,"./gradient":16,"./photo":18,"./swiss-clock":19}],18:[function(require,module,exports){
var ZenModeComponent = require('../lib/mode-component');
var Photo = require('../lib/photo');

var PhotoModeComponent = new ZenModeComponent({
    className: 'pnd-launcher-mode pnd-app-photo animated fadeIn',
    onRender: function () {
        var element = this.getElement();
...
exports.component = PhotoModeComponent;

},{"../lib/mode-component":11,"../lib/photo":12}],19:[function(require,module,exports){
var ZenModeComponent = require('panda-modules/zen/lib/mode-component');
var Settings = require('panda-modules/lib/settings');
var LaunchConfig = require('panda/services/launch-config');
var Photo = require('panda-modules/zen/lib/photo');
...
var ClockModeComponent = new ZenModeComponent({
    className: 'pnd-launcher-mode pnd-app-swiss-clock animated fadeIn',
    template: '<div id="swiss-clock" class="swiss-clock"><div id="swiss-clock-time" class="time"></div></div>',
    onRender: function () {
        var settings = getSettings();
        var $element = $(this.getElement());

        this.inverval_ = setInterval(getTime, 100);
        ...
        function applySettings() {
            ...
            if (settings.fg) {
                $element.find('#swiss-clock-time').css('color', settings.fg.color);
            }

            $element.css('font-family', settings.font);
        }

        function toString(h, m, s) {
            var symbol = '';
            if (settings && settings.show && settings.show['am/pm']) {
                symbol = h < 12 ? ' AM' : ' PM';
                h = toHour12(h);
            }
            ...
            if (settings && settings.show && settings.show['seconds'])
                parts.push(s);

            var sep = ' ';
            if (settings && settings.show && settings.show['separators'])
                sep = ' : ';

            return parts.map(pad).join(sep) + symbol;
        }
        ...
        function getTime() {
            ...
            return document.getElementById('swiss-clock-time').innerHTML = toString(h, m, s);
        }
    },
    onDestroy: function () {
        window.clearInterval(this.inverval_);
...
function getSettings() {
    if (LaunchConfig.isPreview()) {
        ...
        var launcherSettings = Settings.get('launcher') || {};
        var swissClockSettings = (launcherSettings.modes || {})['zen-swiss-clock'];

        return swissClockSettings;
    }
}

},{"jquery":2,"panda-modules/lib/settings":7,"panda-modules/lib/utils":9,"panda-modules/zen/lib/mode-component":11,"panda-modules/zen/lib/photo":12,"panda/services/launch-config":4}]},{},[10]);
